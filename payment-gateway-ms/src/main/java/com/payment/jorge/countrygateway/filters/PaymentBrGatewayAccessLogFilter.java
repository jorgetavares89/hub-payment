package com.payment.jorge.countrygateway.filters;
...
@Component
public class PaymentBrGatewayAccessLogFilter extends ZuulFilter {

    private Logger logger = LoggerFactory.getLogger(PaymentBrGatewayAccessLogFilter.class);
